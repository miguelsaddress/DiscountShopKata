...
=begin
Discount promotions applies a percentage of dicount to every 
item of that kind in the purchase if you buy at least N units. 
For example
...
=begin
Pack promotions are those that when you buy a given number of items
of the same kind, you just pay some of them.
For example
...
=begin 
Final price promotions ar those that, when you buy N units, you
pay a known price.
For Example
